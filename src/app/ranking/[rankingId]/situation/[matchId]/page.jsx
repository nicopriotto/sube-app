...
import SituationVoteWrapper from "@/app/ranking/[rankingId]/situation/[matchId]/client";
...
export default async function RankingSituationVotePage({params}) {
    ...
    if (!token) redirect(`/ranking/${rankingId}/join?redirect=/ranking/${rankingId}/situation/${matchId}`);
    let payload;
    try {
        payload = jwt.verify(token, process.env.JWT_SECRET);
    } catch {
        redirect(`/ranking/${rankingId}/join?redirect=/ranking/${rankingId}/situation/${matchId}`)
    }
    return (
